...
import com.wallpaper4k.live.hd.backgrounds.databinding.ActivityPreviewBinding
import com.wallpaper4k.live.hd.backgrounds.databinding.ItemLockedPopupBinding
import com.wallpaper4k.live.hd.backgrounds.databinding.ItemPremiumPopupBinding
import com.wallpaper4k.live.hd.backgrounds.databinding.ItemSetWallpaperBinding
import com.wallpaper4k.live.hd.backgrounds.model.SettingData
import com.wallpaper4k.live.hd.backgrounds.utils.Const
import com.wallpaper4k.live.hd.backgrounds.utils.MyApplication
...
import com.wallpaper4k.live.hd.backgrounds.viewmodel.PreviewModel
...
class PreviewActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.setContentView(this, com.wallpaper4k.live.hd.backgrounds.R.layout.activity_preview)
...
//                        wallpaperManager.setResource(com.wallpaper4k.live.R.raw.sample_image_1)
                    } catch (e: IOException) {
...
//        val path = getPath() + "/" + name
    ...
    private fun showPremiumPopup() {
        ...
        val view = LayoutInflater.from(this)
            .inflate(com.wallpaper4k.live.hd.backgrounds.R.layout.item_premium_popup, null, false)
    ...
    private fun showLockedPopUp(type: Int) {
        ...
        dialog.window!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        val view = LayoutInflater.from(this)
            .inflate(com.wallpaper4k.live.hd.backgrounds.R.layout.item_locked_popup, null, false)
            ...
            if (selectedWall.wallpaperType == 0) {
                ...
                Glide.with(this@PreviewActivity).load(
                    ...
                    RequestOptions().error(
                        com.wallpaper4k.live.hd.backgrounds.R.color.transparent
                    ).priority(Priority.HIGH)
                ).into(binding.img)
            } else {
                binding.loutLoader.visibility = View.VISIBLE
                binding.btnDownload.setCardBackgroundColor(this.getColorStateList(com.wallpaper4k.live.hd.backgrounds.R.color.color_theme_blue_50))
                binding.btnApply.setCardBackgroundColor(this.getColorStateList(com.wallpaper4k.live.hd.backgrounds.R.color.color_theme_blue_50))
                binding.cardClose.setCardBackgroundColor(this.getColorStateList(com.wallpaper4k.live.hd.backgrounds.R.color.color_theme_blue_50))
